...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a BitcoinPlus address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and bitcoinplus: URIs)"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your BitcoinPlus addresses to prove you own them"));
    verifyMessageAction = new QAction(platformStyle->TextColorIcon(":/icons/verify"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified BitcoinPlus addresses"));
    ...
    openAction->setStatusTip(tr("Open a bitcoinplus: URI or payment request"));

    showHelpMessageAction = new QAction(platformStyle->TextColorIcon(":/icons/info"), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the %1 help message to get a list with possible BitcoinPlus command-line options").arg(tr(PACKAGE_NAME)));
...
{
    QString strTitle = tr("BitcoinPlus"); // default title
