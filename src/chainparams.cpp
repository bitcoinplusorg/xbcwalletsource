...
public:
    CMainParams() {
        ...
        vSeeds.push_back(CDNSSeedData("bitcoinplus.net", "seed1.bitcoinplus.net", false));
        vSeeds.push_back(CDNSSeedData("bitcoinplus.net", "seed2.bitcoinplus.net", false));
        vSeeds.push_back(CDNSSeedData("bitcoinplus.net", "seed3.bitcoinplus.net", false));
        vSeeds.push_back(CDNSSeedData("bitcoinplus.net", "seed4.bitcoinplus.net", false));
