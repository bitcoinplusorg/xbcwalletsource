...
public:
    CMainParams() {
        ...
        vSeeds.push_back(CDNSSeedData("seed1.bitcoinplus.org", "seed1.bitcoinplus.org", false));
        vSeeds.push_back(CDNSSeedData("seed2.bitcoinplus.org", "seed2.bitcoinplus.org", false));
