...
public:
    CMainParams() {
        ...
        consensus.nMinimumChainWork = uint256S("0x0000000000000000000000000000000000000000000000000000124b8ea317c5");

        // By default assume that the signatures in ancestors of this block are valid.
        consensus.defaultAssumeValid = uint256S("0xc881db51bf0786b23ea6be6ee21cd60ee0cd79b98c605d0c0ed177ed087c967d");
        ...
        vSeeds.push_back(CDNSSeedData("ns1.xbcbitcoinplus.co.uk", "seed1.xbcbitcoinplus.co.uk", false));
        vSeeds.push_back(CDNSSeedData("ns2.xbcbitcoinplus.co.uk", "seed2.xbcbitcoinplus.co.uk", false));
        ...
        checkpointData = (CCheckpointData) {
            ...
            (1373800, uint256S("0xc881db51bf0786b23ea6be6ee21cd60ee0cd79b98c605d0c0ed177ed087c967d")),
            1601473524, // * UNIX timestamp of last checkpoint block
            2731627,   // * total number of transactions between genesis and last checkpoint
                        //   (the tx=... number in the SetBestChain debug.log lines)
            1363.0     // * estimated number of transactions per day after checkpoint
        };
    }
};
