...
UniValue gettxout(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 2 || params.size() > 3)
        throw runtime_error(
            ...
            "     \"addresses\" : [          (array of string) array of bitcoinplus addresses\n"
...
UniValue getblockchaininfo(const UniValue& params, bool fHelp)
{
    ...
    softforks.push_back(SoftForkDesc("bip66", 7, tip, consensusParams));
    softforks.push_back(SoftForkDesc("bip65", 7, tip, consensusParams));
